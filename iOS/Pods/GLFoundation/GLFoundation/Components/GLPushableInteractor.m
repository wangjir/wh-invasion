//
//  GLPushableInteractor.m
//  UIViewController-Transitions-Example
//
//  Created by Ash Furrow on 2013-07-18.
//  Copyright (c) 2013 Teehan+Lax. All rights reserved.
//
//  Modified by Xin Zhao on 2014-07-21

#import "GLPushableInteractor.h"
#import "GLUtils.h"

@interface GLPushableInteractor () <UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate, UIViewControllerInteractiveTransitioning>
...
@implementation GLPushableInteractor
...
//    self.presenting = YES;
//    
//    GLPushableViewController *viewController = [[GLPushableViewController alloc] initWithPanTarget:self];
...
-(void)presentViewController:(UIViewController<GLPushablePresentee> *)presentee
{
    self.presenting = YES;
    
    presentee.modalPresentationStyle = UIModalPresentationCustom;
    presentee.transitioningDelegate = self;
    [presentee setInteractorAsPanTarget:self];
    [self.parentViewController presentViewController:presentee animated:YES completion:nil];
}
...
- (void)updateInteractiveTransition:(CGFloat)percentComplete {
    ...
    CGRect frame = CGRectOffset([[transitionContext containerView] bounds],
        CGRectGetWidth([[transitionContext containerView] bounds]) * (percentComplete),
        0);
...
- (void)finishInteractiveTransition {
    ...
    if (self.presenting)
    {
        ...
        CGRect endFrame = CGRectOffset([[transitionContext containerView] bounds],
            CGRectGetWidth([[self.transitionContext containerView] bounds]),
            0);
