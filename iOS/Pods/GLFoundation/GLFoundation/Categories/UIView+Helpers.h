...
/**
 * If using autolayout, use aLeft instead of left
 *
 * Sets self.superview.constrain.firstItem = self
 *      self.superview.constrain.firstAttribute = 
 *         NSLayoutAttributeLeading    (left)
 *         NSLayoutAttributeTrailing   (right)
 *         NSLayoutAttributeTop
 *         NSLayoutAttributeBottom
 */
@property (nonatomic) CGFloat aLeft;
@property (nonatomic) CGFloat aRight;
@property (nonatomic) CGFloat aTop;
@property (nonatomic) CGFloat aBottom;
...
/**
 * If using autolayout, use aWidth instead of width
 *
 * Sets self.constrain.firstItem = self
 *      self.constrain.firstAttribute =
 *         NSLayoutAttributeWidth    (width)
 *         NSLayoutAttributeHeight   (height)
 */
@property (nonatomic) CGFloat aWidth;
@property (nonatomic) CGFloat aHeight;
...
/**
 * Tell if current view is ancestor of the given view
 */
