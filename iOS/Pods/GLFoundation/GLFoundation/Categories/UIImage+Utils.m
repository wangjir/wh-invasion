...
- (GLColorStyle)getColorStyle {
	...
	if (cgctx == NULL) { return GLColorStyleLight; /* error */ }
    ...
    textShadowColor = [UIColor colorWithWhite:textShadowGray alpha:0.4];
    
    return brightness < 0.6 ? GLColorStyleDark : GLColorStyleLight;
}
